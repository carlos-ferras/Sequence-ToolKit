...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", "Apply this to", None, QtGui.QApplication.UnicodeUTF8))
	...
	self.pushButton_3.setText(QtGui.QApplication.translate("Dialog", "Apply to all", None, QtGui.QApplication.UnicodeUTF8))
