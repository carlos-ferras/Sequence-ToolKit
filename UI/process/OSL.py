...
class Ui_Dialog(object):
	...
	self.frame.setStyleSheet(PROCESS_WIN_STYLE)
        ...
        self.label.setGeometry(QtCore.QRect(245, 170, 131, 17))
	...
	self.spinBox_3 = QtGui.QSpinBox(self.frame)
        ...
        self.label_9.setGeometry(QtCore.QRect(425, 110, 121, 17))
	...
	self.pushButton_3.setStyleSheet(PROCESS_BUTTONS_STYLE)
        ...
        self.label_3.setGeometry(QtCore.QRect(460, 170, 120, 17))
