...
class Ui_Dialog(object):
	...
	def retranslateUi(self, Dialog):
		...
		item.setText(QtGui.QApplication.translate("Dialog", "Illumination Source", None, QtGui.QApplication.UnicodeUTF8))
		item = self.listWidget.item(16)
		item.setText(QtGui.QApplication.translate("Dialog", "Illumination Power", None, QtGui.QApplication.UnicodeUTF8))
		item = self.listWidget.item(17)
		item.setText(QtGui.QApplication.translate("Dialog", "Illumination Temperature", None, QtGui.QApplication.UnicodeUTF8))
