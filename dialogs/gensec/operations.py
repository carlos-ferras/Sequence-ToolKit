...
from ui.gensec import uiOperations

class classOperations(uiOperations.classUiOperations):
	"""Ventana para escoger el comando"""
	def __init__(self,parent):
		...
		x= position.x()
		y= position.y()
		self.form1.setGeometry(QtCore.QRect(x+5, y+5, 190, 260))	