...
import sys
from ui.gensec.process  import uiOsl
import infoWin
from PyQt4 import QtGui
from PyQt4 import QtCore
from functools import partial

class classOsl(uiOsl.classUiProcess):
	...
	def data(self):
		...
		return "OSL,  "+str(self.comboBox.currentText())+", "+str(self.spinBox_5.value())+"%" ,all
	...
	def actTimePerChannel(self):
		...
		self.label_16.setText(str(round(self.timePerCanel,2))+' '+unidad)
	...
	def validateDataPoints(self,button):
		...
		if (uno+dos+tres)>512:
			...
			self.label_14.setText(str(self.channels))
			self.actTimePerChannel()
