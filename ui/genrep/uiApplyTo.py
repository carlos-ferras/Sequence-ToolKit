...
class classUiApplyTo(object):
    def setupUi(self, Dialog):
        widget=QtGui.QDesktopWidget()
	mainScreenSize = widget.availableGeometry(widget.primaryScreen())
	self.x= mainScreenSize.width()/2-238
	self.y= mainScreenSize.height()/2-110
	Dialog.setGeometry(QtCore.QRect(self.x, self.y, 477, 221))	
	Dialog.setMinimumSize(QtCore.QSize(477, 221))
        Dialog.setMaximumSize(QtCore.QSize(477, 221))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Apply this to", None, QtGui.QApplication.UnicodeUTF8))
	...
	self.pushButton_3.setText(QtGui.QApplication.translate("MainWindow", "Apply to all", None, QtGui.QApplication.UnicodeUTF8))
	...
	self.comboBox_4.setItemText(0, QtGui.QApplication.translate("MainWindow", "<<select>>", None, QtGui.QApplication.UnicodeUTF8))
        self.comboBox_5.setItemText(0, "Same")
        self.comboBox_5.setItemText(1, "Different")
        self.comboBox_5.setItemText(2, "Value")
        self.comboBox_6.setItemText(0, "Same")
        self.comboBox_6.setItemText(1, "Different")
        self.comboBox_6.setItemText(2, "Value")
        self.comboBox_7.setItemText(0, "Same")
        self.comboBox_7.setItemText(1, "Different")
        self.comboBox_7.setItemText(2, "Value")
	self.comboBox_8.setItemText(0, "Same")
        self.comboBox_8.setItemText(1, "Different")
        self.comboBox_8.setItemText(2, "Value")
